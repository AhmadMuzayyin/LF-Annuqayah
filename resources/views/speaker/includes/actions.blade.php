    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detailModalLabel">Detail speaker {{ $model->course_category }}</h5>
...
<div class="modal fade" id="editModal-{{ $model->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Edit speaker {{ $model->course_category }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('speaker.update', $model) }}" method="post">
                @csrf
                @method('put')
                <div class="modal-body">
...
<div class="modal fade" id="deleteModal-{{ $model->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('speaker.destroy', $model) }}" method="post">
                @csrf
                @method('delete')
                <div class="modal-footer">
